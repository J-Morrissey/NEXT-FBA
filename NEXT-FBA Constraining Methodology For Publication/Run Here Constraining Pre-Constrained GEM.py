...
import pandas as pd
from next_fba_constrained_model2 import next_fba_constrained_model2
...
constrained_model = next_fba_constrained_model2(model,experiment,mapping_table,trained_c13bound_data,solver)
