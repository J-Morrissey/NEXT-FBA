...
#Modify Inputs Here
next_flux(data_to_predict, main_path, alpha=0.95, exclude_different=False, condition='both',
                      condition_alpha ='95', shsh=False, save_bounds=True, save_similarity=True)
